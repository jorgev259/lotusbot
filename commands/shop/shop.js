        ...
        switch(itemName){
            ...
            case "color change":
                ...
                message.author.send("React with the desired color").then(async proposal => {
                    const reacts = [(await proposal.react(message.guild.emojis.get("435809856012681226"))).emoji.id, 
                                    (await proposal.react(message.guild.emojis.get("435809856012681226"))).emoji.id, 
                                    (await proposal.react(message.guild.emojis.get("435809856012681226"))).emoji.id, 
                                    (await proposal.react(message.guild.emojis.get("435809856012681226"))).emoji.id, 
                                    (await proposal.react(message.guild.emojis.get("435809856012681226"))).emoji.id, 
                                    (await proposal.react(message.guild.emojis.get("435809856012681226"))).emoji.id];
